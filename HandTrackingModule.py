...
class handDetector():
    def __init__(self, mode=False, maxHands = 2, detectionsCon = 0.5, trackCon = 0.5):
        ...
        self.detectionsCon = detectionsCon
        self.trackCon = trackCon

        self.mpHands = mp.solutions.hands
        self.hands = self.mpHands.Hands(self.mode, self.maxHands, self.detectionsCon, self.trackCon)
    ...
    def findposition(self, img, handNum):
